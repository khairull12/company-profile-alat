    ...
    <div class="d-flex">
        ...
        <nav class="admin-sidebar position-fixed">
            ...
            <div class="nav flex-column mt-3">
                ...
                <!-- Booking Management -->
                <a href="{{ route('admin.bookings.index') }}" class="nav-link {{ request()->routeIs('admin.bookings.index') || request()->routeIs('admin.bookings.show') || request()->routeIs('admin.bookings.create') || request()->routeIs('admin.bookings.edit') ? 'active' : '' }}">
